...
class WhatsProt
{
    ...
    const WHATSAPP_VER = '2.12.7';                                                          // The WhatsApp version.
    const WHATSAPP_USER_AGENT = 'WhatsApp/2.12.7 S40Version/14.26 Device/Nokia302';         // User agent used in request/registration code.
